main()
{
	...
	jump=spawn("script_model",(2030.09, 1983.75, 352.125));
	jump.angles=(0,119.8,90); // .2
	jump setmodel("xmodel/furniture_bookshelveswide");
	

	a=spawn("script_model",(1529,2193,184-i*12));
	a.angles=(0,151,0);
	a setmodel("xmodel/pallet_d");*/

	//pallet pallet_d facade2
	
	maps\pam\maps::toujane();
