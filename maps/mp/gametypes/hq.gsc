...
main()
{
	...
	{
		level.callbackStartGameType = maps\pam\hq::Callback_StartGameType;
		level.callbackPlayerConnect = maps\pam\hq::Callback_PlayerConnect;
		level.callbackPlayerDisconnect = maps\pam\hq::Callback_PlayerDisconnect;
		level.callbackPlayerDamage = maps\pam\hq::Callback_PlayerDamage;
		level.callbackPlayerKilled = maps\pam\hq::Callback_PlayerKilled;
		maps\mp\gametypes\_callbacksetup::SetupCallbacks();

		level.setdvar = maps\pam\utils\setdvar::Setup_Dvar;

		level.autoassign = maps\pam\hq::menuAutoAssign;
		level.allies = maps\pam\hq::menuAllies;
		level.axis = maps\pam\hq::menuAxis;
		level.spectator = maps\pam\hq::menuSpectator;
		level.weapon = maps\pam\hq::menuWeapon;
		level.endgameconfirmed = maps\pam\hq::endMap;
	}
}
