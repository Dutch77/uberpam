...
main()
{
	...
	{
		level.callbackStartGameType = maps\pam\ctf::Callback_StartGameType;
		level.callbackPlayerConnect = maps\pam\ctf::Callback_PlayerConnect;
		level.callbackPlayerDisconnect = maps\pam\ctf::Callback_PlayerDisconnect;
		level.callbackPlayerDamage = maps\pam\ctf::Callback_PlayerDamage;
		level.callbackPlayerKilled = maps\pam\ctf::Callback_PlayerKilled;
		maps\mp\gametypes\_callbacksetup::SetupCallbacks();

		level.setdvar = maps\pam\utils\setdvar::Setup_Dvar;

		level.autoassign = maps\pam\ctf::menuAutoAssign;
		level.allies = maps\pam\ctf::menuAllies;
		level.axis = maps\pam\ctf::menuAxis;
		level.spectator = maps\pam\ctf::menuSpectator;
		level.weapon = maps\pam\ctf::menuWeapon;
		level.endgameconfirmed = maps\pam\ctf::endMap;
	}
}
