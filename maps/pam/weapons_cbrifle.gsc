...
init()
{
	...
	case "american":
		...
		// ZPAM
		precacheItem("kar98k_sniper_allies_mp");
		precacheItem("mosin_nagant_sniper_allies_mp");
		precacheItem("enfield_scope_allies_mp");
		precacheItem("springfield_allies_mp");
	...
	// ZPAM
	precacheItem("enfield_scope_axis_mp");
	precacheItem("kar98k_sniper_axis_mp");
	precacheItem("mosin_nagant_sniper_axis_mp");
	precacheItem("springfield_axis_mp");
...
isMainWeapon(weapon)
{
	...
	case "bar_mp":
	case "springfield_mp":
	case "springfield_allies_mp":
	case "springfield_axis_mp":
	case "sten_mp":
	case "enfield_mp":
	case "bren_mp":
	case "enfield_scope_mp":
	case "enfield_scope_axis_mp":
	case "enfield_scope_allies_mp":
	case "mosin_nagant_mp":
	case "SVT40_mp":
	case "PPS42_mp":
	case "ppsh_mp":
	case "mosin_nagant_sniper_mp":
	case "mosin_nagant_sniper_allies_mp":
	case "mosin_nagant_sniper_axis_mp":
	case "kar98k_mp":
	case "g43_mp":
	case "mp40_mp":
	case "mp44_mp":
	case "kar98k_sniper_mp":
	case "kar98k_sniper_axis_mp":
	case "kar98k_sniper_allies_mp":
	case "shotgun_mp":
		return true;
	default:
		return false;
...
restrictWeaponByServerCvars(response)
{
	...
	case "springfield_allies_mp": 
		if(!getcvarint("scr_allow_springfield_allies"))
			response = "restricted";
		break;
	
	case "springfield_axis_mp": 
		if(!getcvarint("scr_allow_springfield_axis"))
			response = "restricted";
		break;
	...
	case "enfield_scope_allies_mp": 
		if(!getcvarint("scr_allow_enfieldsniper_allies"))
			response = "restricted";
		break;

	case "enfield_scope_axis_mp": 
		if(!getcvarint("scr_allow_enfieldsniper_axis"))
			response = "restricted";
		break;
	...
	case "mosin_nagant_sniper_allies_mp": 
		if(!getcvarint("scr_allow_nagantsniper_allies"))
			response = "restricted";
		break;

	case "mosin_nagant_sniper_axis_mp": 
		if(!getcvarint("scr_allow_nagantsniper_axis"))
			response = "restricted";
		break;
	...
	case "kar98k_sniper_axis_mp": 
		if(!getcvarint("scr_allow_kar98ksniper_axis"))
			response = "restricted";
		break;

	case "kar98k_sniper_allies_mp": 
		if(!getcvarint("scr_allow_kar98ksniper_allies"))
			response = "restricted";
		break;
