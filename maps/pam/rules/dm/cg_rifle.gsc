Rules()
{
	...
	// setcvar("scr_dm_timelimit_halftime", 1);
	// setcvar("scr_dm_half_score", 0);
	setcvar("scr_dm_end_score", 0);
	setcvar("scr_dm_scorelimit", 0);
	// setcvar("scr_dm_end_half2score", 0);
	// Halftime auto-ready
	...
	// Time-out
	setcvar("g_to", 1); // nr of time-outs a team can have per map; 0 = disabled
	setcvar("g_to_length", 5); // 0 = no auto-resume
	// setcvar("g_to_side", 1); // nr of time-outs a team can have per side
	...
	setcvar("scr_allow_enfieldsniper_allies", 1);
	setcvar("scr_allow_enfieldsniper_axis", 1);
	setcvar("scr_allow_nagantsniper_allies", 1);
	setcvar("scr_allow_nagantsniper_axis", 1);
	setcvar("scr_allow_springfield_axis", 1);
	setcvar("scr_allow_springfield_allies", 1);
	...
	game["leaguestring"] = &"CyberGamer DM Rifle Match Mode";
	game["mode"] = "match";
}