...
{
	// Match Style 
	setcvar("scr_hq_timelimit", 10);
	setcvar("scr_hq_timelimit_halftime", 1);
	setcvar("scr_hq_half_score", 0);
	setcvar("scr_hq_end_score", 0);
	setcvar("scr_hq_end_half2score", 0);
	setcvar("g_halftime_ready", 5); // 0 = disabled

	setcvar("scr_hq_gamestyle", "new");
	...
	setcvar("scr_show_objective_icons", 1);
	...
	game["leaguestring"] = &"CyberGamer HQ 1v1 Ladder Match Mode";
	game["mode"] = "match";
}