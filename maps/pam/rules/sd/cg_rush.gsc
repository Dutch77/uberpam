Rules()
{
	...
	// Bomb Timers
	setcvar("scr_sd_bombtimer", 40);
	setcvar("scr_sd_PlantTime", 3);
	setcvar("scr_sd_DefuseTime", 7);
	...
	game["leaguestring"] = &"CyberGamer S&D Rush Match Mode";
	game["mode"] = "match";
}