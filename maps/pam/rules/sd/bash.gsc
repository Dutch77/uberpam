Rules()
{
	...
	setcvar("scr_sd_half_round", 0);
	setcvar("scr_sd_half_score", 0);
	setcvar("scr_sd_end_round", 0);
	setcvar("scr_sd_end_score", 1);
	setcvar("scr_sd_end_half2score", 0);
	// Halftime auto-ready
	setcvar("g_halftime_ready", 0); // 0 = disabled

	setcvar("scr_sd_roundlength", 0.05);
	...
	// Nade Spawn Counts
	setcvar("scr_boltaction_nades", 0);
	...
	setcvar("scr_allow_fraggrenades", 0);
	...
	game["leaguestring"] = &"S&D Bash Round Mode";
	game["mode"] = "match";
}