Rules()
{
	...
	setcvar("scr_sd_half_round", 15);
	setcvar("scr_sd_half_score", 0);
	setcvar("scr_sd_end_round", 30);
	...
	setcvar("scr_sd_graceperiod", 6);
	setcvar("scr_sd_strat_time", 6);
	setcvar("scr_sd_count_draws", 0);
	...
	game["leaguestring"] = &"S&D MR15 Match Mode";
	game["mode"] = "match";
}