Rules()
{
	...
	setcvar("scr_sd_half_round", 12);
	setcvar("scr_sd_half_score", 0);
	setcvar("scr_sd_end_round", 24);
	...
	setcvar("scr_sd_graceperiod", 4);
	setcvar("scr_sd_strat_time", 3);
	...
	game["leaguestring"] = &"CyberGamer S&D MR12 Match Mode";
	game["mode"] = "match";
}