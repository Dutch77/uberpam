init()
{
	...
	// HUD Show Scorlimit
	level.show_team_scores = 0;
	if (getcvarint("scr_showscorelimit") > 0)
		level.show_team_scores = 1;
...
onUpdateAllHUD()
{
	for(;;)
	{
		level waittill("update_allhud_score");
...
updatePlayerHUD()
{
	...
	if(level.scorelimit > 0 && level.show_team_scores)
	{
	...
	else if (level.show_team_scores)
	{
